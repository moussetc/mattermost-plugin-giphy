...
type MockGiphyHttpClient struct {
	response            *http.Response
	testRequestFunc     func(*http.Request) bool
	lastRequestPassTest bool
}

func (c *MockGiphyHttpClient) Do(req *http.Request) (*http.Response, error) {
...
func (c *MockGiphyHttpClient) Get(s string) (*http.Response, error) {
	return c.response, nil
}

func NewMockGiphyHttpClient(res *http.Response) *MockGiphyHttpClient {
	return &MockGiphyHttpClient{
		response:        res,
		testRequestFunc: nil,
	}
}
...
func TestGiphyProviderGetGIFURLOK(t *testing.T) {
	...
	getGifProviderHttpClient = func() HttpClient { return NewMockGiphyHttpClient(serverResponse) }
...
func generateHttpClientForParameterTest() (p *giphyProvider, client *MockGiphyHttpClient, config configuration, cursor string) {
	p = &giphyProvider{}
	serverResponse := &http.Response{
		Body:       ioutil.NopCloser(bytes.NewBufferString(defaultGiphyresponseBody)),
		StatusCode: 200,
	...
	client = NewMockGiphyHttpClient(serverResponse)
...
func TestGiphyProviderParameterCursorProvided(t *testing.T) {
	p, client, config, cursor := generateHttpClientForParameterTest()
