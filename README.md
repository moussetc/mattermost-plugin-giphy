...
6. You can also configure the following settings :
    ...
    - random (true random is only available for Giphy; for Tenor / Klipy, the random only applies to the current page of results, meaning you'll need to use Shuffle until a new page of results is loaded in order to see new results even in random mode)
